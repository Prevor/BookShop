<template>
  <v-app class="grey darken-4">
      <v-card width="500" class="mx-auto mt-15" >
        <v-form v-model="valid" class="pa-10" ref="form" lazy-validation>
          <v-layout class="d-flex flex-column">
            ...
            <v-flex class="text-center">
              <v-btn rounded color="orange black--text" dark width="200" @click="validate">
                Зареєструватись
              </v-btn>
            ...
            <v-flex class="text-center">
              <v-btn :to="{ name: 'authorization' }" class="black--text"> Вхід </v-btn>
            </v-flex>
          </v-layout>
        </v-form>
      </v-card>
